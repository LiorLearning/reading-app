...
talk to her sometimes and help her by calling her name out`
  ...
  const updateSession = (shouldTriggerResponse: boolean = false) => {
    // Hardcoded VAD settings optimized for spelling tutor
    const turnDetection = {
      type: 'server_vad', // Server-side voice activity detection
      threshold: 0.9, // High threshold for clear speech detection
      prefix_padding_ms: 300, // 300ms before speech starts
