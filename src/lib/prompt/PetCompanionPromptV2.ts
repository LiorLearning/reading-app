export function getPetCompanionPromptV2(
...
- **Each response must be 18–26 words only, strictly without line breaks. Strict range.**
...
## 📏 Interaction Rules  
1. **Keep responses short:** 18–26 words, strictly inside this range, without any line breaks.  
...
export function getGenericOpeningInstructionV2(
  petTypeDescription: string,
  petName?: string,
  userData?: any
): string {
...
- Start gently: ask about their day or share one tiny pet detail.
- Keep it 18–26 words total.
- Keep language very simple and cozy. No extra setup lines.`;
}
